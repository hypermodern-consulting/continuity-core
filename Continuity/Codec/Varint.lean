...
namespace Continuity.Codec.Varint
...
theorem ms (v : UInt64) (h : ¬v < 128) :
  ...
  simp only [UInt8.toBitVec_ofNat, UInt64.toBitVec_toUInt8, UInt64.toBitVec_and,
    UInt64.toBitVec_or, UInt64.toBitVec_ofNat] at this
