...
/- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                                                    // continuity // codec // box
                                                                       box.lean
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ -/

/-!
  Box — the core bidirectional codec with machine-checked roundtrip proof.

  A `Box α` is the strongest statement Continuity makes about a wire format.
  It can serialize an `α` to bytes, parse bytes back to an `α`, and the
  roundtrip is proven correct for all values and all trailing bytes.
  ...
  n.b. "Box" is from Joseph Cornell's boxes. Boxes with things inside them.
-/
...
/-- Parse result: success with unconsumed bytes, or failure. -/
...
-- simp lemmas — these fire inside tactic proofs so seq/isoBox go through
