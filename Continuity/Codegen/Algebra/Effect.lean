...
/- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
      ...
      "The mythform is usually encountered in one of two
      modes. One mode assumes that the forms are by nature
      independent of their expression, that the code is
      separable from the machine that runs it. The other
      assumes that the forms are in some way generated by
      the machine itself, that every effect leaves a trace
      in the world, a grade that accumulates in the lattice
      of what has happened and cannot be unwound."
...
/-
  ...
  Also generates `C++` grade label enums for FFI compatibility.
-/
