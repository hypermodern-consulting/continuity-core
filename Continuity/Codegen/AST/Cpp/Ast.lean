...
/- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
      ...
      "The Dutchman opened a door in his back brain and came
      strolling in to ask questions. It was a trick he had,
      Marly knew, a way of letting you know that he'd been
      there all along, in some corner of the architecture he
      claimed for his own, the way a spider knows every strand
      of its web. She had learned to recognise the silence that
      preceded his arrivals, a particular quality of stillness
      in the room's ambient data, as though the structure itself
...
inductive CType where
  ...
  -- `bool`
  | bool
  -- fixed-width integer: `uint8_t`, `int32_t`, etc. unsigned × bit width
