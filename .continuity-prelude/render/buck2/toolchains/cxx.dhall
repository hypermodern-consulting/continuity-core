...
'')
            with doc = "LLVM 22 toolchain with paths from .buckconfig.local"
            with is_toolchain = True
      , attrs = 
          [ R.stringListAttr "c_extra_flags"
          , R.stringListAttr "cxx_extra_flags"
...
''
          with loads = 
              [ R.load "@prelude//cxx:cxx_toolchain_types.bzl"
                  [ "BinaryUtilitiesInfo", "CCompilerInfo", "CvtresCompilerInfo"
                  , "CxxCompilerInfo", "CxxInternalTools", "CxxPlatformInfo"
                  , "CxxToolchainInfo", "LinkerInfo", "LinkerType", "PicBehavior"
                  , "RcCompilerInfo", "RuntimeDependencyHandling", "ShlibInterfacesMode"
                  ]
              , R.load "@prelude//cxx:headers.bzl" ["HeaderMode"]
              , R.load "@prelude//linking:link_info.bzl" ["LinkStyle"]
              , R.load "@prelude//linking:lto.bzl" ["LtoMode"]
              ]
          with helpers = [ runInfoHelper ]
          with rules = [ llvmToolchain ]
