...
#
# Custom Haskell build rules using GHC from Nix.
#
# The toolchain itself is registered via system_haskell_toolchain from
# the prelude (in the generated toolchains/BUCK). This file provides
# rules the prelude doesn't: packages attr, language_extensions,
# haskell_ffi_binary, haskell_c_library, haskell_script.
#
# Paths are read from .buckconfig.local [haskell] section.
#
# Rules:
#   haskell_library    - compile to .hi/.o with HaskellLibraryInfo
#   haskell_binary     - executable from sources + deps + packages
...
# ═══════════════════════════════════════════════════════════════════════════════
# TOOLCHAIN — handled by system_haskell_toolchain from the prelude.
# See toolchains/BUCK (generated by continuity).
# ═══════════════════════════════════════════════════════════════════════════════
